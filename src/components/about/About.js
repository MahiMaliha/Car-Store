...
Fully Customizable and every page can be fully customized so you will not have any problems using your own logo, texts or other elements to design it in the way you want. Click below link now to see how our theme works:</p>
    <br></br>
    <Button variant="secondary" className='Details-button text-white '>Read More</Button>
  ...
  <Row>
    <Col xs={12} sm={12} md={12} lg={12}>
        <img src='https://autozone.templines.org/elementor/rental/wp-content/uploads/2022/01/tw2.jpg' className='img-fluid  about-image'></img>
    </Col>
  </Row>
</Container>
    </Col>
